...
st.markdown('<p style="font-size:2.2rem; font-weight:bold; color:#1f77b4; margin-bottom:1rem;">📊 CES DI 统计工具</p>', unsafe_allow_html=True)
...
def aggrid_table(df: pd.DataFrame, columns: list = None, height: int = 300, page_size: int = 10, link_column: str = None, all_columns: list = None, table_key: str = "default", pagination: bool = True):
    ...
    AgGrid(
        ...
        enableCellHtml=True,
        custom_css={
            ".ag-cell": {"display": "flex !important", "justify-content": "center !important", "align-items": "center !important", "border-right": "1px solid #ddd !important"},
    ...
    if not st.session_state.df_raw.empty:
        ...
        with col4:
            ...
            with st.popover("合格标准", width='stretch'):
                ...
                <tr><td style='padding: 8px; border: 1px solid #ddd;'>修复/待修复</td><td style='padding: 8px; border: 1px solid #ddd; text-align: center;'>统计</td><td style='padding: 8px; border: 1px solid #ddd; text-align: center;'>统计</td><td style='padding: 8px; border: 1px solid #ddd; text-align: center;'>非生产按SLA超期计算</td></tr>
